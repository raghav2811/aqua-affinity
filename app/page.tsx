...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: '100dvh', background: '#0d1117', overflow: 'hidden' }}>
      <Header
        userType={userType}
        ...
        {loading && userType === 'industry' ? (
          <div className="w-full h-full flex items-center justify-center" style={{ background: '#0d1117' }}>
            <div className="text-center">
              ...
              <p className="text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Connecting to database…</p>
            </div>
          </div>
        ) : (
          <MapWrapper
